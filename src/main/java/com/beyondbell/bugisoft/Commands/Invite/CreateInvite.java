package com.beyondbell.bugisoft.Commands.Invite;

import com.beyondbell.bugisoft.Utilities.Converters.StringToInteger;
...
public class CreateInvite {
	...
	public CreateInvite(MessageReceivedEvent event, String timeInput) {
		...
		try {
			this.timeout = StringToInteger.convert(timeInput);
